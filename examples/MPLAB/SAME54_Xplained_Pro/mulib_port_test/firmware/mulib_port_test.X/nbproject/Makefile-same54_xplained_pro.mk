...
${OBJECTDIR}/_ext/2127081275/mu_vm.o: C\:/Users/r/Projects/mulib/examples/MPLAB/SAME54_Xplained_Pro/mulib_port_test/firmware/src/mu_vm.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/2127081275" 
	@${RM} ${OBJECTDIR}/_ext/2127081275/mu_vm.o.d 
	@${RM} ${OBJECTDIR}/_ext/2127081275/mu_vm.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/2127081275/mu_vm.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG   -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -fdata-sections -O1 -I"../src" -I"../src/config/same54_xplained_pro" -I"../src/packs/ATSAME54P20A_DFP" -I"../src/packs/CMSIS/CMSIS/Core/Include" -I"../src/packs/CMSIS/" -Werror -Wall -MMD -MF "${OBJECTDIR}/_ext/2127081275/mu_vm.o.d" -o ${OBJECTDIR}/_ext/2127081275/mu_vm.o C:/Users/r/Projects/mulib/examples/MPLAB/SAME54_Xplained_Pro/mulib_port_test/firmware/src/mu_vm.c    -DXPRJ_same54_xplained_pro=$(CND_CONF)    $(COMPARISON_BUILD)  -mdfp=${DFP_DIR} ${PACK_COMMON_OPTIONS} 
