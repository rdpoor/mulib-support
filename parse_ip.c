...
int ParseIPv4OrIPv6(const char **ppszText, unsigned char *abyAddr, int *pnPort,
                    int *pbIsIPv6) {
...
int ParseIPv4OrIPv6_2(const char *pszText, unsigned char *abyAddr, int *pnPort,
                      int *pbIsIPv6) {
...
int main(int argc, char *argv[]) {
  ...
  // Rosetta Code's primary server's public IPv6 address, with a specified port
  // (80)
